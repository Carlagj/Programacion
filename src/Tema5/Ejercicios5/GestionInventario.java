...
public class GestionInventario {
    public static void main(String[] args) {
        ...
        // Pista: El Set usará vuestro metodo equals/hashCode[cite: 2696].
        Set<Producto> productosUnicos = new LinkedHashSet<>(entradaAlmacen); // Completar
