...
public class ElectroAvilaMain {
    public static void main(String[] args) {
        ...
        //añadir a fernando 600 en ventas em burgos
       /* ventasPorZona.get("Burgus").put("Fernando", 600);
        ...
        */
        ...
        for (String zona : zonas) {
            ...
            for (String vendedor : vendedores) {
                ...
                ventasPorVendedor.get(vendedor).put(zona, valor);
